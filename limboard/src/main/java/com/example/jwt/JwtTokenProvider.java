...
public class JwtTokenProvider {
    private UserDetailsService boardDetailsService;

    @Autowired
    public JwtTokenProvider(UserDetailsService boardDetailsService){
        this.boardDetailsService = boardDetailsService;
    }
    ...
    public Authentication getAuthentication(String token){
        ...
        UserDetails userDetails = boardDetailsService.loadUserByUsername(this.getUsername(token));
